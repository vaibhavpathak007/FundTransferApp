...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferAmount(@RequestBody @Valid AmountTransferRequest amountTransferRequest) {
    log.info("Amount transfer request {}", amountTransferRequest);
    try {
      this.accountsService.transferAmount(amountTransferRequest);
    } catch (TransactionTimeoutException | InterruptedException e) {
